...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/AddProvider.html" enctype="multipart/form-data">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                    <label for="proDesc">供应商营业执照：</label>
                    <input type="file" name="pic" style="border: none;box-shadow:none"> 
                </div>
