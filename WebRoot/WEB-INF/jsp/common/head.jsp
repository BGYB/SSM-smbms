...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/showBill.html">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/showAll.do">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/showBypage.do">用户管理</a></li>
